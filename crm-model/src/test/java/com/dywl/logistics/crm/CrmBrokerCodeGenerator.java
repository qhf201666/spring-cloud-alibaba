...
public class CrmBrokerCodeGenerator {
  ...
  private static String author = "窦洋洋";
  //model name
...
/*  private static String dataSourceUrl = "jdbc:mysql://localhost:3306/test?useUnicode=true&serverTimezone=GMT&useSSL=false&characterEncoding=utf8";
  ...
  //要生成的表名 数组
  private static String[] tableNames = {"crm_broker_log"};
  //生成实体去掉表前缀
...
//                .setBaseColumnList(true);
    ...
    packageConfig.setParent(basePath)
        .setService("dao.broker")
        .setServiceImpl("dao.impl.broker")
        .setEntity("entity.broker")
        .setMapper("mapper.broker")
        .setXml("mapper.xml.broker")
